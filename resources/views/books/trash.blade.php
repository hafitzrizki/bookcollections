...
<div class="row">
    <div class="col-md-4">
        <ul class="nav nav-pills card-header-pills" style="padding-left:12px;">
            <li class="nav-item">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form class="d-inline" action="{{route('books.delete-permanent', [$book->id])}}" method="POST" onsubmit="return confirm('Delete this book permanently?')">
                            @csrf
